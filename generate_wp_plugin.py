...
os.makedirs('minimore-carousel', exist_ok=True)
with open('minimore-carousel/minimore-carousel.php', 'w') as f:
    f.write(plugin_code)

with zipfile.ZipFile('minimore-carousel.zip', 'w') as zipf:
    zipf.write('minimore-carousel/minimore-carousel.php', arcname='minimore-carousel/minimore-carousel.php')

print("Created minimore-carousel.zip successfully!")
